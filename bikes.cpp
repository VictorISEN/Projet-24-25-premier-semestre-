...
bool Bike::canTurn(bool CTop, bool CBottom, bool CLeft, bool CRight, std::vector<Bus>& buses, std::vector<Bike>& bikes, std::vector<Car>& cars) {
    ...
    for (int i = 0; i < buses.size(); i++)
    {
        // si il tourne vers le haut
        if (this->getDestination() == entry::top && this->getDirection().x == 1) {
            if ((buses.at(i).getDirection().x == -1 && buses.at(i).getX() >= 515 - 40 && buses.at(i).getX() <= 515 + safe_distance_bus + 100 && buses.at(i).getDestination() != entry::top) ||
                (buses.at(i).getDirection().x == 1 && buses.at(i).getX() <= 515 + 40 && buses.at(i).getX() >= 515 - safe_distance_bus - 100 && buses.at(i).getDestination() != entry::top) || CTop == false)
                return false;
        }
        // si il tourne vers le bas
        if (this->getDestination() == entry::bottom && this->getDirection().x == -1) {
            if ((buses.at(i).getDirection().x == 1 && buses.at(i).getX() >= 485 - safe_distance_bus - 100 && buses.at(i).getX() <= 458 + 40 && buses.at(i).getDestination() != entry::bottom) ||
                (buses.at(i).getDirection().x == -1 && buses.at(i).getX() <= 485 + safe_distance_bus + 100 && buses.at(i).getX() >= 458 - 40 && buses.at(i).getDestination() != entry::bottom) || CBottom == false)
                return false;
        }
        // si il tourne vers la gauche
        if (this->getDestination() == entry::left && this->getDirection().y == 1) {
            if ((buses.at(i).getDirection().y == 1 && buses.at(i).getY() >= 485 - safe_distance_bus - 100 && buses.at(i).getY() <= 458 + 40 && buses.at(i).getDestination() != entry::left) ||
                (buses.at(i).getDirection().y == -1 && buses.at(i).getY() <= 485 + safe_distance_bus + 100 && buses.at(i).getY() >= 458 - 40 && buses.at(i).getDestination() != entry::left) || CLeft == false)
                return false;
        }
        // si il tourne vers la droite
        if (this->getDestination() == entry::right && this->getDirection().y == -1) {
            if ((buses.at(i).getDirection().y == -1 && buses.at(i).getY() >= 515 - 40 && buses.at(i).getY() <= 515 + safe_distance_bus + 100 && buses.at(i).getDestination() != entry::right) ||
                (buses.at(i).getDirection().y == 1 && buses.at(i).getY() <= 515 + 40 && buses.at(i).getY() >= 515 - safe_distance_bus - 100 && buses.at(i).getDestination() != entry::right) || CRight == false)
                return false;
        }
    }
